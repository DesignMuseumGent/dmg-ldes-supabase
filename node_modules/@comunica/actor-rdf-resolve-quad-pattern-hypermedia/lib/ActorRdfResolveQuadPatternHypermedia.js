...
class ActorRdfResolveQuadPatternHypermedia extends bus_rdf_resolve_quad_pattern_1.ActorRdfResolveQuadPatternSource {
    ...
    getSource(context, operation) {
        ...
        if (this.cache && this.cache.has(url)) {
            ...
            source = new MediatedQuadSource_1.MediatedQuadSource(this.cacheSize, context, url, (0, bus_rdf_resolve_quad_pattern_1.getDataSourceType)(contextSource), this.maxIterators, this.aggregateStore, {
