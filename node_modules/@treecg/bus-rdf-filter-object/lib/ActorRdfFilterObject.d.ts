 ...
 */
export declare abstract class ActorRdfFilterObject extends Actor<IActionRdfFilterObject, IActorTest, IActorRdfFilterObjectOutput> {
    /**
...
export declare type MediatorRdfFilterObject = Mediate<IActionRdfFilterObject, IActorRdfFilterObjectOutput>;
