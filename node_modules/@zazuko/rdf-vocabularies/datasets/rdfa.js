...
exports.default = ({ literal, namedNode, quad }) => {
    return [
        ...
        quad(namedNode(rdfa), namedNode(`${dcterms}description`), literal(`This document describes the RDFa Vocabulary for Term and Prefix Assignment. The Vocabulary is used to modify RDFa 1.1 processing behavior.`), namedNode(rdfa)),
