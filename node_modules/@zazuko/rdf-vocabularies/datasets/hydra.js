...
exports.default = ({ literal, namedNode, quad }) => {
    return [
        ...
        quad(namedNode(`${ns4}core`), namedNode(`${dcterms}rights`), literal(`Copyright © 2012-2014 the Contributors to the Hydra Core Vocabulary Specification`), namedNode(hydra)),
